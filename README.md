...
![screencapture-deepsnow6-github-io-Weather-dashboard-2023-05-25-23_09_53](https://github.com/deepsnow6/Weather-dashboard/assets/130337959/2c657c83-eaa8-42ca-a519-796e7b5b79a4)
...
1. Search for a city: Users can enter the name of any city to get the weather forecast.

2. Current weather conditions: The app displays the current temperature, humidity, wind speed, and weather description for the searched city.

3. Weather icon: An icon representing the current weather condition is displayed to provide visual context.

4. 5-day forecast: Users can view the weather forecast for the next 5 days, including temperature, weather description, humidity, and wind speed.

5. Search history: The app keeps a record of previously searched cities for quick access and reference.

6. Dynamic background: The background image changes based on the current weather condition, enhancing the visual experience.


## Installation
Open the Github repository: https://github.com/deepsnow6/Portfolio-website.

Select "Download ZIP" from the "Code" menu to download the project files in a compressed ZIP folder locally.

Unzip said file and extract the contents of the folder.

Launch the "index.html" file in the browser of your choice.
...
The Weather Forecast App utilizes the OpenWeather API for retrieving weather data. OpenWeather provides a comprehensive weather API that offers current weather information, forecasts, and more. https://openweathermap.org/
